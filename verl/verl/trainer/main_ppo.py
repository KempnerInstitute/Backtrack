...
import torch
from verl.utils.reward_score import gsm8k, math, boxes, guessnumber, countdown, sudoku
...
def _default_compute_score(config,data_source, solution_str, ground_truth):
    ...
    elif data_source == "sunnytqin/countdown":
        return countdown.compute_score(solution_str, ground_truth)
    elif data_source == "sunnytqin/sudoku":
        return sudoku.compute_score(solution_str, ground_truth)
    else:
